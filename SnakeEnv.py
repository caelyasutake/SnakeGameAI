...
class SnakeEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # observation
        self.observation = [self.snake_list[0][0], self.snake_list[0][1], self.apple_pos[0],
                            self.apple_pos[1], action]
    ...
    def reset(self):
        ...
        self.observation = [self.snake_list[0][0], self.snake_list[0][1], self.apple_pos[0],
                            self.apple_pos[1], self.numerical_dir]
        ...
        if self.render_mode == 'human':
            ...
            self.font = pygame.font.SysFont('Arial_bold', 300)

            self.renderl()

        return self.observation

    def renderl(self, render_mode='human'):
        # draw
